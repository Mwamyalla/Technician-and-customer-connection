    ...
    <div id="layout">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+255700000000"><i class="fa fa-phone"></i> +255700000000</a></li>
                            <li><a href="mailto:technician@gmail.com"><i class="fa fa-envelope"></i>
                                    technician@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+255700000000"><i class="fa fa-phone"></i>
                                    +255700000000</a></li>
                            <li class="text-right"><a href="changelocation.html"><i
                                        class="fa fa-map-marker"></i>Dodoma, Tanzania</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="changelocation.html"><i class="fa fa-map-marker"></i> Dodoma,
                                    Tanzania</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                        <a href="/">TECHNICIANS<!-- <img src="{{asset('images/logo.png')}}"> --></a>
                    </li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Udom, Dodoma, Tanzania</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:technician@gmail.com">technician@gmail.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+255700000000">+255700000000</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+255700000000">+255700000000</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2022 Technician and customers. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
