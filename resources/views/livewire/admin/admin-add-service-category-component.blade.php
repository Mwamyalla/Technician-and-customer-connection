<main id="main" class="main">
   ...
   <section class="section dashboard justify-content-center align-items-center d-flex">
  <div class="row">
       <div class="col-lg-6">
         <div class="card">
           <div class="card-header">
             <div class="row">
                 <div class="col-md-6"> <h5 class="card-title">Add New Category</h5></div>
           ...
           <div class="card-body">
             ...
             <form class="row g-3" wire:submit.prevent="createNewCategory">
                 @csrf
               <div class="col-12">
                 <label for="inputAddress5" class="form-label">Category Name</label>
               ...
               <div class="form-group">
                   ...
                   <div class="col-sm-9">
                       <input type="file" class="form-control" name="image" wire:model="image">
                        ...
                        @if($image)
                          <img src="{{$image->temporaryUrl()}}" width="70px" class="g-3"/>
                        @endif
                   </div>
               </div>
